...
public class Checkpoint {
    ...
    public static Map<Integer,Checkpoint> generatePoints() {
        ...
        checkpoints.put(1, new Checkpoint("1", 1, new ArrayList<Checkpoint>(){{add(new Checkpoint("0", 0)); add(new Checkpoint("2", 2));add(new Checkpoint("3", 3)); add(new Checkpoint("4", 4)); add(new Checkpoint("5", 5));}}));
